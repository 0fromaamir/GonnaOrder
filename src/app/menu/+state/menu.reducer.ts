...
const generateMenuItems = (storeId, storeAlias) => ([
  ...
  {
    key: 'admin.store.statistics.reservations',
    url: `/manager/stores/${storeId}/reservations`,
    icon: 'fas fa-calendar',
    storeRoles: ['STORE_ADMIN', 'STORE_STANDARD']
  },
  {
    key: 'admin.store.statistics.standalonePayment',
    url: `/manager/stores/${storeId}/standalonePayments`,
    icon: 'far fa-solid fa-credit-card',
    storeRoles: ['STORE_ADMIN', 'STORE_STANDARD']
  },
  {
    key: 'admin.store.settings.catalog.title',
    url: '/manager/stores/' + storeId + '/catalog',
    icon: 'fas fa-atlas',
    storeRoles: ['STORE_ADMIN', 'STORE_STANDARD']
  },
  {
    key: 'admin.printer.printersList',
    url: '/manager/printers/list',
    icon: 'fas fa-print',
    onlyMobile: true
  },
  {
    key: 'admin.store.settings.title',
