...
export class CustomErrorHandler implements ErrorHandler {
    ...
    constructor(private injector: Injector, private whitelabelService: WhitelabelService) { }
    ...
    handleError(error) {
        ...
        if (windowRefSer.nativeWindowLocation.hostname.startsWith('admin') || this.whitelabelService.isWhiteLabelDomain(windowRefSer.nativeWindowLocation.hostname)) {
            // Admin side
