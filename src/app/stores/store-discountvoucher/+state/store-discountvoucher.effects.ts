...
export class StoresEffects {
    ...
    onLoadDiscountVoucher = createEffect(() => this.actions$.pipe(
    ...
    onLoadDiscountVouchers = createEffect(() => this.actions$.pipe(
    ...
    onSaveDiscountVoucher = createEffect(() => this.actions$.pipe(
    ...
    onSaveDiscountVoucherSuccess = createEffect(() => this.actions$.pipe(
    ...
    onDeleteDiscountVoucher = createEffect(() => this.actions$.pipe(
    ...
    onDeleteDiscountVoucherSuccess = createEffect(() => this.actions$.pipe(
    ...
    onStoreDiscountVoucherActionFailed = createEffect(() => this.actions$.pipe(
