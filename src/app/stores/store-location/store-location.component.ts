...
import { CreateStoreLocation, OpenStoreLocationCreationForm, CloseStoreLocationCreationForm, LoadStoreLocationsPage,
  LoadStoreLocations,
  DownloadLocationPinPdf} from './+state/store-location.actions';
...
export class StoreLocationComponent implements OnInit, OnDestroy {
  ...
  onOrderPrint(locationData: any) {
    this.store.dispatch(new DownloadLocationPinPdf(this.storeId, locationData.id));
  }
