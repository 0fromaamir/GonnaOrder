...
export enum StoreLocationActionType {
  ...
  DownloadLocationPinPdf = '[stores] DownloadLocationPinPdf',
  PrintPdfSuccess = '[stores] PrintPdfSuccess'
}
...
export class DownloadLocationPinPdf implements Action {
  readonly type = StoreLocationActionType.DownloadLocationPinPdf;
  constructor(public readonly storeId: number, public readonly locationId: number){}
}

export class PrintPdfSuccess implements Action {
  readonly type = StoreLocationActionType.PrintPdfSuccess;
  constructor(public readonly blob: Blob, public readonly filename: string){}
}
