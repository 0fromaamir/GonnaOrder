...
export const getCategoryImage = createSelector(getCategoryState, (state: Category) => state.imageUrl);
export const getStationData = createSelector(getCategoryState, (state: Category) => state.categoryDetails.stationData);

export const getOfferAvailability = createSelector(getOfferState, (state: Offer) => state.availability);
export const getSelectedCatalogIds = createSelector(getCatalogState, (state:Catalog) => state.cataloglist.selectedCatalogIds);