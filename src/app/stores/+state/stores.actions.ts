import { CustomEndPointValidationRequest } from './../stores';
...
import {
  ...
  PowersoftLoginRequest, StoreRelationRequest, Relation, StoreRelations
} from '../stores';
...
import { NotificationSubscriptions } from 'src/app/shared/notifications';
...
export enum StoresActionType {
  ...
  DeleteStoreParent = '[stores] DeleteStoreParent',
  DeleteStoreParentSuccess = '[stores] DeleteStoreParentSuccess',
  DeleteStoreParentFailed = '[stores] DeleteStoreParentFailed',
  ...
  ChangeAccountManager = '[stores] ChangeAccountManager',
  ChangeAccountManagerSuccess = '[stores] ChangeAccountManagerSuccess',
  ChangeAccountManagerFailed = '[stores] ChangeAccountManagerFailed',
  ...
  LoadMenuViewingStatistics = '[stores] LoadMenuViewingStatistics',
  LoadMenuViewingStatisticsFailed = '[stores] LoadMenuViewingStatisticsFailed',
  LoadMenuViewingStatisticsSuccess = '[stores] LoadMenuViewingStatisticsSuccess',
  ...
  UpdateNotificationSubscriptions = '[stores] UpdateNotificationSubscriptions',

  LoadAutoprintSubscriptionStatus = '[stores] LoadAutoprintSubscriptionStatus',
  LoadAutoprintSubscriptionStatusSuccess = '[stores] LoadAutoprintSubscriptionStatusSuccess',
  LoadAutoprintSubscriptionStatusFailed = '[stores] LoadAutoprintSubscriptionStatusFailed',
  
  RequestAutoprintPermission =  '[stores] RequestAutoprintPermission',
  ToggleAutoprintSubscriptionStatus = '[stores] ToggleAutoprintSubscriptionStatus',
  ToggleAutoprintSubscriptionStatusSuccess = '[stores] ToggleAutoprintSubscriptionStatusSuccess',
  ToggleAutoprintPermitted = '[stores] ToggleAutoprintPermitted',
  ...
  SynchronizePowersoftCatalog = '[stores] SynchronizePowersoftCatalog',
  SynchronizePowersoftCatalogSuccess = '[stores] SynchronizePowersoftCatalogSuccess',
  SynchronizePowersoftCatalogFailed = '[stores] SynchronizePowersoftCatalogFailed',

  UpdateStoreRelation = '[stores] UpdateStoreRelation',
  UpdateStoreRelationSuccess = '[stores] UpdateStoreRelationSuccess',
  UpdateStoreRelationFailed = '[stores] UpdateStoreRelationFailed',

  CustomEndPointValidate = '[integrations] CustomEndPointValidate',
  CustomEndPointValidateSuccess = '[integrations] CustomEndPointValidateSuccess',
  CustomEndPointValidateFailed = '[integrations] CustomEndPointValidateFailed',
}
...
export class ChangeAccountManager implements Action {
  readonly type = StoresActionType.ChangeAccountManager;
  constructor(public storeId: number, public readonly userId: number, public readonly paging: Paging) { }
}

export class ChangeAccountManagerSuccess implements Action {
  readonly type = StoresActionType.ChangeAccountManagerSuccess;
  constructor(public readonly storeId: number, public readonly paging: Paging ) { }
}

export class ChangeAccountManagerFailed implements Action {
  readonly type = StoresActionType.ChangeAccountManagerFailed;
  constructor() { }
}
...
export class PartialUpdateStoreSuccess implements Action {
  ...
  constructor(public readonly store: ClientStore, public readonly clientStore: ClientStoreRequest) { }
...
export class DeleteStoreParent implements Action {
  readonly type = StoresActionType.DeleteStoreParent;
...
export class DeleteStoreParentSuccess implements Action {
  readonly type = StoresActionType.DeleteStoreParentSuccess;
...
export class DeleteStoreParentFailed implements Action {
  readonly type = StoresActionType.DeleteStoreParentFailed;
...
@ShowLoader()
export class UpdateStoreRelation implements Action {
  readonly type = StoresActionType.UpdateStoreRelation;

  constructor(public readonly storeRelationRequest: StoreRelationRequest,
              public readonly parentStoreDetail: any, public readonly isUpdate?: boolean) {
  }

}

@HideLoader(StoresActionType.UpdateStoreRelation)
export class UpdateStoreRelationSuccess implements Action {
  readonly type = StoresActionType.UpdateStoreRelationSuccess;

  constructor(public readonly storeId: number, public readonly parentStoreRelations: any) { }

}

@HideLoader(StoresActionType.UpdateStoreRelation)
export class UpdateStoreRelationFailed implements Action {
  readonly type = StoresActionType.UpdateStoreRelationFailed;
...
export class UpdateStoreSettingsFailed implements Action {
  ...
  constructor(public readonly storeId?: number, public readonly error?: string[]) { }
...
export class UploadStoreImage implements Action {
  ...
  constructor(public readonly file: File, public readonly backgroundImage = false) { }
}
...
export class UploadStoreImageSuccess implements Action {
  ...
  constructor(public readonly imageUrl: string,  public readonly backgroundImage = false) { }
}
@HideLoader(StoresActionType.UploadStoreImage)
export class UploadStoreImageFailed implements Action {
  readonly type = StoresActionType.UploadStoreImageFailed;

  constructor(public readonly errorMessages: string[], public readonly backgroundImage = false) { }
}
@ShowLoader()
...
export class LoadMenuViewingStatistics implements Action {
  readonly type = StoresActionType.LoadMenuViewingStatistics;
...
export class LoadMenuViewingStatisticsSuccess implements Action {
  readonly type = StoresActionType.LoadMenuViewingStatisticsSuccess;

  constructor(public readonly statistics: StoreStatistics[]) { }
}

export class LoadMenuViewingStatisticsFailed implements Action {
  readonly type = StoresActionType.LoadMenuViewingStatisticsFailed;
...
export class UpdateNotificationSubscriptions implements Action {
  readonly type = StoresActionType.UpdateNotificationSubscriptions;

  constructor(public readonly subscriptions: NotificationSubscriptions) { }
}

//START automatic printer
export class LoadAutoprintSubscriptionStatus implements Action {
  readonly type = StoresActionType.LoadAutoprintSubscriptionStatus;

  constructor(public readonly storeId: number) { }
}

export class LoadAutoprintSubscriptionStatusSuccess implements Action {
  readonly type = StoresActionType.LoadAutoprintSubscriptionStatusSuccess;

  constructor(public readonly autoprintStatus: boolean) { }
}

export class LoadAutoprintSubscriptionStatusFailed implements Action {
  readonly type = StoresActionType.LoadAutoprintSubscriptionStatusFailed;

  constructor(public readonly errors: string[]) { }
}

export class RequestAutoprintPermission implements Action {
  readonly type = StoresActionType.RequestAutoprintPermission;

  constructor() { }
}

export class ToggleAutoprintSubscriptionStatus implements Action {
  readonly type = StoresActionType.ToggleAutoprintSubscriptionStatus;

  constructor(public readonly newStatus: boolean) { }
}

export class ToggleAutoprintSubscriptionStatusSuccess implements Action {
  readonly type = StoresActionType.ToggleAutoprintSubscriptionStatusSuccess;

  constructor(public readonly newStatus: boolean) { }
}

export class ToggleAutoprintPermitted implements Action {
  readonly type = StoresActionType.ToggleAutoprintPermitted;

  constructor(public readonly permissionStatus: boolean) { }
}
//END automatic printer
...
export class RemoveStoreImage implements Action {
  ...
  constructor(public readonly storeId: number, public readonly backgroundImage = false) { }
}
...
export class SynchronizePowersoftCatalog implements Action {
  readonly type = StoresActionType.SynchronizePowersoftCatalog;

  constructor(public readonly storeId: number) { }

}

export class SynchronizePowersoftCatalogSuccess implements Action {
  readonly type = StoresActionType.SynchronizePowersoftCatalogSuccess;

  constructor() { }

}

export class SynchronizePowersoftCatalogFailed implements Action {
  readonly type = StoresActionType.SynchronizePowersoftCatalogFailed;
...
export class CustomEndPointValidate implements Action {
  readonly type = StoresActionType.CustomEndPointValidate;

  constructor(
    public readonly storeId, public readonly method,
    public readonly customEndPointValidationRequest: CustomEndPointValidationRequest
    ) {}

}

export class CustomEndPointValidateSuccess implements Action {
  readonly type = StoresActionType.CustomEndPointValidateSuccess;

  constructor(public readonly endpoint: string) {}

}

export class CustomEndPointValidateFailed implements Action {
  readonly type = StoresActionType.CustomEndPointValidateFailed;
...
export type StoresAction =
  ...
  | ChangeAccountManagerSuccess
  | ChangeAccountManagerFailed
  | InviteUser
  | InviteUserSuccess
  | InviteUserFailed
  ...
  | LoadMenuViewingStatistics
  | LoadMenuViewingStatisticsFailed
  | LoadMenuViewingStatisticsSuccess
  ...
  | LoadAutoprintSubscriptionStatusSuccess
  | LoadAutoprintSubscriptionStatusFailed
  ...
  | CustomEndPointValidate
  | CustomEndPointValidateSuccess
  | CustomEndPointValidateFailed
  ;
