...
export class StoreSchedulesComponent implements OnInit, OnDestroy {
  ...
  helpUrl: string;
  helpUrlSlot: string;
  helpUrlDesiredTime: string;
  helpUrlWishTimeMinutes: string;
  helpUrlSlotDuration: string;
  helpUrlDefaultOrderingMode: string;
  ...
  ngOnInit() {
    this.helpUrl = 'requestOrderDateUpfront';
    this.helpUrlSlot = 'maximumItemsPerSlot';
    this.helpUrlDesiredTime = 'requestDesiredTime';
    this.helpUrlWishTimeMinutes = 'DesiredTimeInMinutes';
    this.helpUrlSlotDuration = 'SlotDurationInMinutes';
    this.helpUrlDefaultOrderingMode = 'defaultOrderingMode';
    ...
    this.store.pipe(
      ...
      if (s.settings) {
        ...
        this.settingsForm
          .get('WISH_DATE_PER_ORDER_ITEM')
          .setValue(s.settings.WISH_DATE_PER_ORDER_ITEM || 'DISABLED');
      }
    });
  }
