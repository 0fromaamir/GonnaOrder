...
export function sharePaymentLinkUrl(state: String = storesSubscriptionsInitialState.sharePaymentLinkUrl,
                        action: StoreSubscriptionsAction): any {
  switch (action.type) {
    case StoreSubscriptionsActionType.GenerateSubscriptionPaymentLinkSuccess:
      return action.sharePaymentLinkUrl
    case StoreSubscriptionsActionType.UpdateSubscriptionPurchaseSuccess:
    default:
      return '';
  }
