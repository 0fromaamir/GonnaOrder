...
export enum StoreSubscriptionsActionType {
  ...
  GenerateSubscriptionPaymentLink = '[storeSubscriptions] GenerateSubscriptionPaymentLink',
  GenerateSubscriptionPaymentLinkSuccess = '[storeSubscriptions] GenerateSubscriptionPaymentLinkSuccess',
  GenerateSubscriptionPaymentLinkFail = '[storeSubscriptions] GenerateSubscriptionPaymentLinkFail',
  ...
  UpdatePrice = '[storeSubscriptions] UpdatePrice',
  UpdatePriceSuccess = '[storeSubscriptions] UpdatePriceSuccess',
  UpdatePriceFailed = '[storeSubscriptions] UpdatePriceFailed',
}
...
export class GenerateSubscriptionPaymentLink implements Action {
  readonly type = StoreSubscriptionsActionType.GenerateSubscriptionPaymentLink;

  constructor(public readonly provider: string) { }

}

export class GenerateSubscriptionPaymentLinkSuccess implements Action {
  readonly type = StoreSubscriptionsActionType.GenerateSubscriptionPaymentLinkSuccess;

  constructor(public readonly sharePaymentLinkUrl: string) { }

}

export class GenerateSubscriptionPaymentLinkFail implements Action {
  readonly type = StoreSubscriptionsActionType.GenerateSubscriptionPaymentLinkFail;
...
export class UpdatePrice implements Action {
  readonly type = StoreSubscriptionsActionType.UpdatePrice;

  constructor(public readonly storeId: any, public readonly request: any) { }
}

export class UpdatePriceSuccess implements Action {
  readonly type = StoreSubscriptionsActionType.UpdatePriceSuccess;
  updatedPrices: any;

  constructor(public readonly storeId: number) { }
}

export class UpdatePriceFailed implements Action {
  readonly type = StoreSubscriptionsActionType.UpdatePriceFailed;
