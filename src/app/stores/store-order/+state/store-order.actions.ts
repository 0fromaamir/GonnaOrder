...
export class LoadStoreOrder implements Action {
  ...
  constructor(public readonly storeId: number, public readonly orderUuid: string, public readonly stationId?: number) {}

}
@HideLoader(StoreOrderActionType.LoadStoreOrder)
