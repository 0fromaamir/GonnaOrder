...
export class RuleOptionComponent implements OnInit, OnDestroy {
  ...
  saveOffer() {
    ...
    this.optionStore.dispatch(
      new SaveOffer(
        saveOfferRequest, offerId, this.storeId, this.catalogId, this.optionGroupId, null, null, this.ruleId,
  ...
  deleteOffer() {
    ...
    dialogRef.afterClosed().subscribe(action => {
      if (action === 'DELETE') {
        this.optionStore.dispatch(new DeleteOffer(this.storeId, this.catalogId, this.optionId, null, this.ruleId,
          null, null, null, null, null, null, this.optionGroupId));
      }
    });
  }
