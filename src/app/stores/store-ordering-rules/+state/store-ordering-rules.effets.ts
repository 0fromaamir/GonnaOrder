...
export class StoresEffects {
  ...
  onLoadOrderingRule = createEffect(() => this.actions$.pipe(
  ...
  onLoadOrderingRules = createEffect(() => this.actions$.pipe(
  ...
  onSaveOrderingRule = createEffect(() => this.actions$.pipe(
  ...
  onSaveOrderingRuleSuccess = createEffect(() => this.actions$.pipe(
  ...
  onSaveOrderingRuleFailed = createEffect(() => this.actions$.pipe(
  ...
  onDeleteOrderingRule = createEffect(() => this.actions$.pipe(
  ...
  onDeleteOrderingRuleSuccess = createEffect(() => this.actions$.pipe(
  ...
  onDeleteOrderingRuleFailed = createEffect(() => this.actions$.pipe(
