...
export class UserDetailsFormComponent implements OnInit, OnChanges, OnDestroy {
  ...
  ngOnInit() {
    this.profileForm = this.fb.group({
      ...
      countryId: [{ value: this.user.countryId, disabled: !this.isSuperAdmin }, Validators.compose([Validators.required])],
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (this.profileForm && changes.isSuperAdmin) {
  ...
  submitAction() {
    const userSubmit: UserProfile = {
      ...
      countryId: this.profileForm.get('countryId').value,
      preferredLanguageId: this.profileForm.get('languageId').value
    };
