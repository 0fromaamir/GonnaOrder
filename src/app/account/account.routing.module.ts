...
const routes: Routes = [
  ...
  { path: 'update', component: ProfileUpdateComponent, canActivate: mapToCanActivate([UserGuard]) },
  { path: 'delete', component: DeleteUserComponent, canActivate: mapToCanActivate([UserGuard]) },
  { path: 'password/update', component: PasswordChangeComponent },
  { path: 'password/create', component: PasswordCreateComponent },
  { path: 'social-accounts/update', component: SocialAccountsComponent, canActivate: mapToCanActivate([UserGuard]) },
