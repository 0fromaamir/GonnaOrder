...
export class UserEffects {
  ...
  onAddUserAffiliateSuccess = createEffect(() => this.actions$.pipe(
  ...
  onGetUserAffiliate = createEffect(() => this.actions$.pipe(
  ...
  onUpdateAffiliate = createEffect(() => this.actions$.pipe(
  ...
  onUserAffiliateSuccess = createEffect(() => this.actions$.pipe(
  ...
  onCreateVoucherFailed = createEffect(() => this.actions$.pipe(
  ...
  onLoadVouchers = createEffect(() => this.actions$.pipe(
  ...
  onLoadVouchersPage = createEffect(() => this.actions$.pipe(
  ...
  onLoadCommissions = createEffect(() => this.actions$.pipe(
  ...
  onLoadCommissionsPage = createEffect(() => this.actions$.pipe(
  ...
  onGetVoucherPaymentMethod = createEffect(() => this.actions$.pipe(
  ...
  onCreateVoucher = createEffect(() => this.actions$.pipe(
  ...
  onCreateVoucherSuccess = createEffect(() => this.actions$.pipe(
  ...
  onDownloadVoucherPdf = createEffect(() => this.actions$.pipe(
